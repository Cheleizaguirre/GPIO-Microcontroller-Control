...
# ENCENDIDOS
dirOn17 = f"sudo /./home/julian/on17R.sh" #LUZ ROJA
dirOn22 = f"sudo /./home/julian/on22R.sh" #LUZ VERDE

# APAGADOS
dirOff17 = f"sudo /./home/julian/off17R.sh" #LUZ ROJA
dirOff22 = f"sudo /./home/julian/off22R.sh" #LUZ VERDE

# TXT
dirTxt = f"/home/julian/estado.txt"
dirRemoteTxt = f"/home/julian/check.sh"

# DIRRECION DEL CORREO
dirEmailRON = f"/home/julian/lecturaRON.sh"
dirEmailROFF = f"/home/julian/lecturaROFF.sh"

# DIRECCION DEL SENSORPIR
dirsensorPIRON = f"/home/julian/sensorRON.sh"
dirsensorPIROFF = f"/home/julian/sensorROFF.sh"

def actualiza201():
    os.system(f"{dirRemoteTxt} > estado.txt")
    pf1 = open(dirTxt, "r")
    for linea in pf1:
        campo = linea.split("\n")
        campof = campo[0]
...
def Tiempo():
    ...
    if (ct == "1"):
        def Register():
            ...
            ano = "*"
            user = "root"
            path1 = "sudo /./home/julian/onTemR.sh"
            path2 = "sudo /./home/julian/offTemR.sh"
...
def EvaluarCheckEmail27():
    ...
    r = checkEmail27.get()
    if r == "1":
        proceso_email = subprocess.Popen(["sh",dirEmailRON])
    if r == "0":
        os.system(dirEmailROFF)
...
def EvaluarProcesoSensor():
    ...
    r = checkSensor.get()
    if r == "1":
        proceso_sensor = subprocess.Popen(["python3",dirsensorPIRON])
    if r == "0":
        os.system(dirsensorPIROFF)
